/**
 * Deploy the ProofPresence contract to a Midnight network (undeployed by
...
async function main() {
  console.log('\n╔══════════════════════════════════════════════════════════════╗');
  console.log(`║  Deploy ProofPresence to ${network}`);
  console.log('╚══════════════════════════════════════════════════════════════╝\n');
  ...
  // what the next block's timestamp accounts for. Sleep ~1 block-time.
  ...
  console.log(`  Next: npm run cli  (or npm run server for the web UI)\n`);
}
